...
function ProofUploadModal({payment,busy,error,onBack,onSubmit,initialReferenceNumber=''}){
  const isGcash=payment==='gcash'
...
export function OrderReviewPage(){
  ...
  return <main className="customer-main review-order-page">
    ...
    {modal==='proof'&&<ProofUploadModal payment={form.payment} busy={busy} error={error} initialReferenceNumber={form.paymentReference} onBack={()=>{setError('');setModal('payment')}} onSubmit={place}/>}
